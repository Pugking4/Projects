...
async def scrape(version, difficulty, segaid, password):
    async with async_playwright() as p:
        ...
        #await page.wait_for_selector('div[class="music_basic_score_back pointer w_450 m_15 p_3 f_0"]')
        ...
        print(f"Saved version {version} as output_{difficulty}.txt'")
        #print(len(results))
